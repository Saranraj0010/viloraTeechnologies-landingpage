      ...
      <div className=" relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid gap-10 justify-center sm:grid-cols-2 mx-20 lg:grid-cols-3">
            ...
            <div className="group relative border border-blue-200  p-8 flex flex-col items-center text-center ">
              <div className="w-20 h-20 cursor-pointer rounded-full bg-blue-100 flex items-center justify-center group-hover:bg-blue-600 transition-all duration-300" onClick={handleCopy}>
                <Phone
                  size={36}
                  className="text-blue-600 group-hover:text-white transition-all duration-300"
                />
            ...
            <div className="group border border-blue-200  p-8 flex flex-col items-center text-center  ">
              <a href="https://maps.app.goo.gl/RZWDAnrVS584vrcS9" target="_blank" className="w-20 h-20 rounded-full bg-blue-100 flex items-center justify-center group-hover:bg-blue-600 transition-all duration-300">
                <LocationEdit size={36} className="text-blue-600 group-hover:text-white transition-all duration-300" />
              </a>
